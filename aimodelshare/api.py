...
class create_prediction_api_class():
    ...
    def __init__(self, model_filepath, unique_model_id, model_type, categorical, labels, apiid, custom_libraries, requirements, repo_name="", image_tag="", memory=None, timeout=90, pyspark_support=False):
        ...
        self.eval_layer_map = {
            "us-east-1": "arn:aws:lambda:us-east-1:585666012274:layer:eval-layer-python3-12:1",
        ...
        self.auth_layer_map = {
            "us-east-1": "arn:aws:lambda:us-east-1:585666012274:layer:aimsauth-layer-python3-12:2",
            ...
            "eu-west-1": "arn:aws:lambda:eu-west-1:585666012274:layer:aimsauth-layer-python3-12:2",
