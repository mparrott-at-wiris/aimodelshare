...
TRANSLATIONS = {
    "en": {
        ...
        "s3_analysis_text": "The AI 'Missed' the warning. It is a 'missed warning'.<br><b>The Cost:</b> Public safety was compromised, creating new victims and eroding trust in the justice system.",
        ...
        "s4_fp_label": "Innocents Jailed (False Alarms)",
        "s4_fn_label": "Criminals Released (Missed Warnings)",
        "s4_feed_lenient": "⚠️ <b>Too Lenient!</b> You reduced False Alarms (False Positives), but now <b>crime has spiked</b> (High Missed Warnings/False Negatives).",
    ...
    "ca": {
        ...
        "s4_fp_label": "Persones classificades de baix risc a la presó (falsos positius)",
        "s4_fn_label": "Persones classificades d'alt risc alliberades (falsos negatius)",
