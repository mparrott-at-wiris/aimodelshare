...
TRANSLATIONS = {
    ...
    "ca": {
        ...
        "s3_mean_p2": "Els acusats negres s'enfrontaven a un risc molt més gran de ser <strong class='emph-danger'>injustament etiquetats com a perillosos</strong>, la qual cosa potencialment conduïa a sentències de presó més llargues o a que se’ls denegués la llibertat condicional, fins i tot quan no haurien tornat a cometre un delicte.",
