...
TRANSLATIONS = {
    ...
    "es": {
        ...
        "s2_p1": "Un modelo similar al tuyo se utilizó realmente en el mundo real. Fue usado por jueces en todo Estados Unidos para ayudar a tomar decisiones sobre el futuro de personas presas.",
