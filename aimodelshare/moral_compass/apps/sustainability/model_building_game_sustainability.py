...
def create_model_building_game_sustainability_app(theme_primary_hue: str = "indigo") -> "gr.Blocks":
    """
...
def launch_model_building_game_sustainability_app(height: int = 1200, share: bool = False, debug: bool = False) -> None:
    """
    ...
    demo = create_model_building_game_sustainability_app()
