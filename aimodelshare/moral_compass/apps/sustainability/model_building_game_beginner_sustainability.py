...
# Gradio App Factory
# ---------------------------------------------------------------------
def create_model_building_game_beginner_sustainability_app(theme_primary_hue: str = "indigo") -> "gr.Blocks":
    css = """
    .panel {
        background:#fff;
        padding:18px;
...
# Launcher
# ---------------------------------------------------------------------
def launch_model_building_game_beginner_sustainability_app(height: int = 1100, share: bool = False, debug: bool = False):
