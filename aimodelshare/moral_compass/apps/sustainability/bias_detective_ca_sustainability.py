...
QUIZ_CONFIG = {
    1: {
        "t": "t1",
        "q": "Acabes d'aprendre que una sola consulta d'IA consumeix ~0,5 L d'aigua i ~10 Wh d'energia. Un company diu: *\u00abAix\u00f2 no \u00e9s pr\u00e0cticament res \u2014 no importa.\u00bb* **Quin \u00e9s el millor contraargument?**",
        "o": [
            "A) El teu company t\u00e9 ra\u00f3 \u2014 mig litre i 10 watts-hora s\u00f3n insignificants, fins i tot a escala, comparats amb ind\u00fastries com el transport.",
            "B) Una consulta \u00e9s petita, per\u00f2 200 milions d'usuaris enviant m\u00e9s de 50 consultes/dia signifiquen milers de milions de litres d'aigua i terawatts-hora d'energia a l'any \u2014 els costos invisibles s'acumulen.",
            "C) El veritable problema \u00e9s nom\u00e9s l'aigua, no l'energia \u2014 l'electricitat ve de la xarxa, per\u00f2 l'aigua es perd per sempre per evaporaci\u00f3.",
        ],
        "a": "B) Una consulta \u00e9s petita, per\u00f2 200 milions d'usuaris enviant m\u00e9s de 50 consultes/dia signifiquen milers de milions de litres d'aigua i terawatts-hora d'energia a l'any \u2014 els costos invisibles s'acumulen.",
        "success": "<strong>Puntuaci\u00f3 desbloquejada!</strong> Els costos min\u00fasculs per consulta es tornen enormes a escala. 200 M d'usuaris \u00d7 50 consultes = impacte ambiental real.",
    },
    2: {
        "t": "t2",
        "q": "GPT-4 va utilitzar ~62 000 MWh per al seu entrenament \u2014 48 vegades m\u00e9s que GPT-3. Per\u00f2 despr\u00e9s de l'entrenament, els usuaris envien m\u00e9s de 200 M de consultes/dia (infer\u00e8ncia). **Qu\u00e8 costa m\u00e9s amb el temps?**",
        "o": [
            "A) L'entrenament sempre \u00e9s el cost m\u00e9s gran \u2014 cada nou model requereix reentrenament des de zero, i els models segueixen creixent cada any.",
            "B) La infer\u00e8ncia supera l'entrenament en dies perqu\u00e8 baix-cost-per-consulta \u00d7 volum massiu = energia total que eclipsa l'entrenament i mai deixa de cr\u00e9ixer.",
            "C) S\u00f3n aproximadament iguals \u2014 l'entrenament \u00e9s un pic puntual, per\u00f2 la infer\u00e8ncia \u00e9s tan eficient per consulta que els totals s'equilibren en un any.",
        ],
        "a": "B) La infer\u00e8ncia supera l'entrenament en dies perqu\u00e8 baix-cost-per-consulta \u00d7 volum massiu = energia total que eclipsa l'entrenament i mai deixa de cr\u00e9ixer.",
        "success": "Dada clau desbloquejada. L'entrenament de GPT-3 va durar mesos d'energia \u2014 els usuaris ho van igualar en nom\u00e9s 11 dies d'infer\u00e8ncia.",
    },
    3: {
        "t": "t3",
        "q": "Un sol centre de dades gran consumeix 19 milions de litres d'aigua dol\u00e7a al dia, i nom\u00e9s el 0,5% de l'aigua de la Terra \u00e9s aigua dol\u00e7a accessible. **Per qu\u00e8 el consum d'aigua de la IA planteja problemes de just\u00edcia ambiental?**",
        "o": [
            "A) No en planteja \u2014 els centres de dades utilitzen aigua municipal per la qual paguen, com qualsevol altre negoci. El mercat distribueix l'aigua de manera justa.",
            "B) Els centres de dades consumeixen aigua dol\u00e7a dels mateixos rius i aqu\u00edfers dels quals depenen les comunitats \u2014 sovint en zones propenses a la sequera on les fam\u00edlies ja estan racionant l'aigua.",
            "C) L'aigua es retorna al cicle h\u00eddric mitjan\u00e7ant l'evaporaci\u00f3, de manera que el subministrament global d'aigua dol\u00e7a no canvia. La preocupaci\u00f3 \u00e9s l'energia, no l'aigua.",
        ],
        "a": "B) Els centres de dades consumeixen aigua dol\u00e7a dels mateixos rius i aqu\u00edfers dels quals depenen les comunitats \u2014 sovint en zones propenses a la sequera on les fam\u00edlies ja estan racionant l'aigua.",
        "success": "Crisi de l'aigua confirmada. A Mesa, Arizona, les fam\u00edlies escur\u00e7aven les dutxes durant una sequera de 1200 anys mentre Microsoft evaporava 212 milions de litres/any a prop.",
    },
    4: {
        "t": "t4",
...
function aceUpdatePromptCalc(val) {
    ...
    var stats = [
        ...
        {l:'Per any', v:yearL+'L', i:'\\ud83d\\udcc5', s:yearBottles+' ampolles'}
    ];
    var html = '';
...
def create_bias_detective_ca_sustainability_app(theme_primary_hue: str = "indigo"):
    with gr.Blocks(
        ...
        with gr.Column(visible=False) as main_app_col:
            ...
            with gr.Accordion("Com es calcula la puntuaci\u00f3 de Br\u00faixola Moral?", open=False):
                gr.HTML("""
                    <div style="padding:12px; font-size:0.92rem; line-height:1.6;">
                        ...
                        <div style="background:var(--background-fill-secondary); padding:12px 16px; border-radius:8px; font-family:monospace; font-size:1rem; margin-bottom:10px; border:1px solid var(--border-color-primary);">
                            Puntuaci&oacute; Br&uacute;ixola Moral = Precisi&oacute; x (Passos completats / Passos totals)
                        </div>
                        <ul style="margin:0; padding-left:20px;">
                            <li><strong>Precisi&oacute;</strong> &mdash; La puntuaci&oacute; de precisi&oacute; del teu model de l'Activitat 4 (de 0 a 1).</li>
                            <li><strong>Passos completats</strong> &mdash; Quants passos d'investigaci&oacute; has respost correctament fins ara.</li>
                            <li><strong>Passos totals</strong> &mdash; El nombre total de preguntes del qüestionari en tota la investigaci&oacute;.</li>
                        </ul>
                        <div style="margin-top:10px; padding:8px 12px; background:rgba(99,102,241,0.08); border-radius:6px; font-size:0.88rem;">
                            La teva puntuaci&oacute; augmenta a mesura que avances en la investigaci&oacute;. Una puntuaci&oacute; perfecta significa alta precisi&oacute; del model <em>i</em> completar tots els passos de raonament &egrave;tic.
                        </div>
                    </div>
                """)
