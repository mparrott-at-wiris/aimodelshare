...
ES_FINAL_CONCLUSION_STRINGS = {
    ...
    "registration_line": "Tu sistema de IA optimizado ha sido inscrito en el registro para el EdTech Congress Barcelona 2026.",
...
CA_FINAL_CONCLUSION_STRINGS = {
    ...
    "registration_line": "El teu sistema d'IA optimitzat ha entrat al registre per a l'EdTech Congress Barcelona 2026.",
