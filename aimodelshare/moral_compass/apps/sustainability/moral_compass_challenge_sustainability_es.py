        ...
        <div class="card">
            ...
            <div class="mission-step" id="step-3">
                ...
                <div class="btn-group" style="justify-content: center;">
                    ...
                    <button class="btn" id="btnContinueReset"
                        style="opacity: 0; pointer-events: none;" onclick="goToStep(4)">INTRODUCIR NUEVA M&Eacute;TRICA</button>
                </div>
            </div>
            ...
            <div class="mission-step" id="step-4">
                ...
                <div class="btn-group">
                    ...
                    <button class="btn" onclick="showTransition()">INICIAR AUDITOR&Iacute;A DE
