        ...
        "html": """
            <div class="scenario-box" style="border:none; background:transparent; box-shadow:none; padding:0;">
                <div class="ace-reveal" style="animation-delay:0s;">
                    ...
                    <h2 class="ace-heading">Una pregunta a ChatGPT = <span style="color:var(--ace-accent);">una botella de agua</span></h2>
                </div>
                <div class="ace-reveal" style="animation-delay:0.15s;">
                    <div style="background:var(--ace-accent-highlight); border-left:4px solid var(--ace-accent); border-radius:16px; padding:20px 24px; margin-bottom:8px;">
                        <p style="margin:0; font-size:1.05rem; line-height:1.6; color:var(--ace-text);">
                            ...
                            La &eacute;tica gu&iacute;a c&oacute;mo construimos y usamos la IA. Seguimos la orientaci&oacute;n experta del Observatorio de &Eacute;tica en Inteligencia Artificial de Catalu&ntilde;a <strong>OEIAC (UdG)</strong>, que define 7 principios fundamentales de una IA segura. Esta investigaci&oacute;n se centra en la <strong>Sostenibilidad</strong> &mdash; el principio de que los sistemas de IA deben evitar da&ntilde;os a largo plazo al medio ambiente.
                        </p>
                    </div>
                </div>
...
QUIZ_CONFIG = {
    1: {
        "t": "t1",
        "q": "Acabas de aprender que una sola consulta de IA consume ~0,5 L de agua y ~10 Wh de energ\u00eda. Un compa\u00f1ero dice: *\u00abEso no es pr\u00e1cticamente nada \u2014 no importa.\u00bb* **\u00bfCu\u00e1l es el mejor contraargumento?**",
        "o": [
            "A) Tu compa\u00f1ero tiene raz\u00f3n \u2014 medio litro y 10 vatios-hora son insignificantes, incluso a escala, comparados con industrias como el transporte.",
            "B) Una consulta es peque\u00f1a, pero 200 millones de usuarios enviando m\u00e1s de 50 consultas/d\u00eda significan miles de millones de litros de agua y teravatios-hora de energ\u00eda al a\u00f1o \u2014 los costes invisibles se acumulan.",
            "C) El verdadero problema es solo el agua, no la energ\u00eda \u2014 la electricidad viene de la red, pero el agua se pierde para siempre por evaporaci\u00f3n.",
        ],
        "a": "B) Una consulta es peque\u00f1a, pero 200 millones de usuarios enviando m\u00e1s de 50 consultas/d\u00eda significan miles de millones de litros de agua y teravatios-hora de energ\u00eda al a\u00f1o \u2014 los costes invisibles se acumulan.",
        "success": "<strong>\u00a1Puntuaci\u00f3n desbloqueada!</strong> Los costes min\u00fasculos por consulta se vuelven enormes a escala. 200 M de usuarios \u00d7 50 consultas = impacto ambiental real.",
    },
    2: {
        "t": "t2",
        "q": "GPT-4 us\u00f3 ~62 000 MWh para su entrenamiento \u2014 48 veces m\u00e1s que GPT-3. Pero tras el entrenamiento, los usuarios env\u00edan m\u00e1s de 200 M de consultas/d\u00eda (inferencia). **\u00bfQu\u00e9 cuesta m\u00e1s con el tiempo?**",
        "o": [
            "A) El entrenamiento siempre es el mayor coste \u2014 cada nuevo modelo requiere reentrenamiento desde cero, y los modelos siguen creciendo cada a\u00f1o.",
            "B) La inferencia supera al entrenamiento en d\u00edas porque bajo-coste-por-consulta \u00d7 volumen masivo = energ\u00eda total que eclipsa al entrenamiento y nunca deja de crecer.",
            "C) Son aproximadamente iguales \u2014 el entrenamiento es un pico puntual, pero la inferencia es tan eficiente por consulta que los totales se equilibran en un a\u00f1o.",
        ],
        "a": "B) La inferencia supera al entrenamiento en d\u00edas porque bajo-coste-por-consulta \u00d7 volumen masivo = energ\u00eda total que eclipsa al entrenamiento y nunca deja de crecer.",
        "success": "Dato clave desbloqueado. El entrenamiento de GPT-3 llev\u00f3 meses de energ\u00eda \u2014 los usuarios lo igualaron en solo 11 d\u00edas de inferencia.",
    },
    3: {
        "t": "t3",
        "q": "Un solo centro de datos grande consume 19 millones de litros de agua dulce al d\u00eda, y solo el 0,5% del agua de la Tierra es agua dulce accesible. **\u00bfPor qu\u00e9 el consumo de agua de la IA plantea problemas de justicia ambiental?**",
        "o": [
            "A) No los plantea \u2014 los centros de datos usan agua municipal por la que pagan, como cualquier otro negocio. El mercado distribuye el agua de forma justa.",
            "B) Los centros de datos consumen agua dulce de los mismos r\u00edos y acu\u00edferos de los que dependen las comunidades \u2014 a menudo en zonas propensas a la sequ\u00eda donde las familias ya est\u00e1n racionando el agua.",
            "C) El agua se devuelve al ciclo h\u00eddrico mediante la evaporaci\u00f3n, por lo que el suministro global de agua dulce no cambia. La preocupaci\u00f3n es la energ\u00eda, no el agua.",
        ],
        "a": "B) Los centros de datos consumen agua dulce de los mismos r\u00edos y acu\u00edferos de los que dependen las comunidades \u2014 a menudo en zonas propensas a la sequ\u00eda donde las familias ya est\u00e1n racionando el agua.",
        "success": "Crisis del agua confirmada. En Mesa, Arizona, las familias acortaban sus duchas durante una sequ\u00eda de 1200 a\u00f1os mientras Microsoft evaporaba 212 millones de litros/a\u00f1o cerca.",
    },
    4: {
        "t": "t4",
                ...
                with gr.Column(
                    ...
                    with gr.Row():
                        ...
                        next_label = (
                            "Siguiente \u25b6\ufe0f"
                            if i < len(MODULES) - 1
                            else "\U0001f389 \u00a1Investigaci\u00f3n completada!"
                        )
