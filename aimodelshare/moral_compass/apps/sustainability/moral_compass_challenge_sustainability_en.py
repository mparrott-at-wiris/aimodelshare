        ...
        <div class="card">
            ...
            <div class="mission-step active" id="step-1">
                ...
                <div class="btn-group" style="justify-content: center;">
                    <button class="btn success" style="width: 100%;" onclick="goToStep(2)">PUBLISH MODEL &amp; CERTIFY &rarr;</button>
                </div>
            </div>
...
def get_html_content(best_score_pct, rank_str, is_demo=False):
    ...
    if is_demo:
        demo_banner = """<div style="background:rgba(251,191,36,0.15); border:2px solid #f59e0b; padding:12px; border-radius:8px; margin-bottom:20px; text-align:center;">
            <strong style="color:#d97706;">Demo Mode:</strong> <span style="color:var(--text-dim);">Your real model score could not be loaded. Showing example values.</span>
        </div>"""
...
def create_moral_compass_challenge_sustainability_en_app(theme_primary_hue: str = "indigo"):
    with gr.Blocks(title="Activity 5: The Sustainability Cost") as demo:
        html = gr.HTML()
