                        ...
                        <div id="mcc-stats-reveal" style="opacity:0; transform:translateY(20px); transition:all 0.8s ease;">
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin:30px 0; max-width:500px; width:100%;">
                                <div class="mcc-stat-card">
                                    ...
                                    <div class="mcc-stat-label">Precisi&oacute; del Model</div>
                                </div>
                                <div class="mcc-stat-card">
                                    <div class="mcc-stat-value" style="color:var(--mcc-success);" id="mcc-rank-display">#N/A</div>
                                    <div class="mcc-stat-label">Classificaci&oacute; Global</div>
                                </div>
                            </div>
                            <div id="mcc-achievement-reveal" style="opacity:0; transform:translateY(15px); transition:all 0.6s ease;">
                                <div style="border:2px solid var(--mcc-success); background:var(--mcc-success-bg); border-radius:16px; padding:20px 24px; margin-bottom:24px; max-width:500px; width:100%;">
                                    <p style="margin:0; font-size:1.05rem; line-height:1.6; color:var(--mcc-text); text-align:center;">
                                        <strong style="color:var(--mcc-success);">Assoliment Desbloquejat:</strong><br>
                                        Has constru&iuml;t una IA que prediu quins edificis malgasten energia. Dades reals de sat&egrave;l&middot;lit. Prediccions reals. Aix&ograve; &eacute;s enginyeria de veritat.
                                    </p>
                                </div>
                ...
                <div id="mcc-cert-phase2" style="display:none;">
                    <div style="text-align:center; margin-bottom:24px;">
                        <div style="font-size:0.875rem; font-weight:800; letter-spacing:3px; color:var(--mcc-accent); text-transform:uppercase; margin-bottom:12px;">
                            Auditoria de Certificaci&oacute;
                        </div>
                        <h2 style="font-size:clamp(1.4rem, 4vw, 1.8rem); font-weight:800; color:var(--mcc-text); margin:0;">
                            Executant verificacions pr&egrave;vies a la certificaci&oacute;...
                        </h2>
                    </div>
                    ...
                    <div id="mcc-cert-warning" style="display:none; max-width:560px; margin:20px auto;">
                        <div style="background:var(--mcc-accent-highlight); border:2px solid var(--mcc-accent); border-radius:16px; padding:24px; text-align:center;">
                            <h3 style="color:var(--mcc-accent); margin:0 0 12px 0; font-size:1.4rem; letter-spacing:2px;">ESPERA &mdash; HI HA ALGUNA COSA QUE NO HAS VIST.</h3>
                            <p style="margin:0 0 8px 0; font-size:1.05rem; color:var(--mcc-text);">
                                La teva IA funciona. Per&ograve; cada predicci&oacute; que fa t&eacute; un cost ocult &mdash; energia, aigua i emissions de carboni en qu&egrave; la majoria d'enginyers mai no pensen.
                            </p>
                            <p style="margin:0; font-size:1rem; color:var(--mcc-text-dim);">
                                Descobrim com &eacute;s aquest cost.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="scenario-box" style="border:none; background:transparent; box-shadow:none; padding:0;">
                <div class="mcc-reveal" style="animation-delay:0s;">
                    <div style="text-align:center; margin-bottom:8px;">
                        ...
                        <p style="font-size:1.05rem; color:var(--mcc-text-dim); margin:0 0 8px 0;">Toca cada targeta per descobrir el que realment costa la IA.</p>
                ...
                <div class="mcc-reveal" style="animation-delay:0.15s;">
                    <div class="mcc-flip-card" id="mcc-card-0" onclick="mccFlipCard(0)">
                        <div class="mcc-flip-card-front">
                            ...
                            <div style="font-size:1.1rem; font-weight:700; color:var(--mcc-text);">Energia</div>
                            <div style="font-size:0.9rem; color:var(--mcc-text-dim); margin-top:8px;">Toca per revelar</div>
                        </div>
                        <div class="mcc-flip-card-back" id="mcc-card-back-0">
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                                <div class="mcc-knockout-stat">
                                    <div style="font-size:2rem; margin-bottom:8px;">&#9889;</div>
                                    <div style="font-size:1.6rem; font-weight:800; color:var(--mcc-accent);">M&eacute;s gran que un pa&iacute;s</div>
                                    <p style="font-size:0.95rem; color:var(--mcc-text); margin:8px 0 0 0; line-height:1.5;">
                                        Els centres de dades del m&oacute;n ja consumeixen m&eacute;s electricitat que <strong>tot el Regne Unit</strong> &mdash; i la IA &eacute;s la part que m&eacute;s r&agrave;pidament creix
                                    </p>
                                </div>
                                <div class="mcc-knockout-stat">
                                    <div style="font-size:2rem; margin-bottom:8px;">&#128200;</div>
                                    <div style="font-size:1.6rem; font-weight:800; color:var(--mcc-accent);">48&times; m&eacute;s energia en nom&eacute;s 3 anys</div>
                                    <p style="font-size:0.95rem; color:var(--mcc-text); margin:8px 0 0 0; line-height:1.5;">
                                        Cada nova generaci&oacute; de models d'IA consumeix molta m&eacute;s energia. Entrenar els &uacute;ltims xatbots requereix unes <strong>40&ndash;48&times; m&eacute;s energia</strong> que la versi&oacute; de fa nom&eacute;s tres anys
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mcc-reveal" style="animation-delay:0.3s;">
                    <div class="mcc-flip-card" id="mcc-card-1" onclick="mccFlipCard(1)">
                        <div class="mcc-flip-card-front">
                            <div style="font-size:2.5rem; margin-bottom:12px;">&#128274;</div>
                            <div style="font-size:1.1rem; font-weight:700; color:var(--mcc-text);">Aigua</div>
                            <div style="font-size:0.9rem; color:var(--mcc-text-dim); margin-top:8px;">Toca per revelar</div>
                        </div>
                        <div class="mcc-flip-card-back" id="mcc-card-back-1">
                            <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
                                <div class="mcc-knockout-stat">
                                    <div style="font-size:2rem; margin-bottom:8px;">&#128167;</div>
                                    <div style="font-size:1.6rem; font-weight:800; color:var(--mcc-accent);">Tanta aigua com totes les ampolles venudes al m&oacute;n</div>
                                    <p style="font-size:0.95rem; color:var(--mcc-text); margin:8px 0 0 0; line-height:1.5;">
                                        Els investigadors estimen que la petjada h&iacute;drica total de la IA ja iguala <strong>tot el subministrament mundial d'aigua embotellada</strong> &mdash; i la majoria de la gent no ho sap
                                    </p>
                                </div>
                                <div class="mcc-knockout-stat">
                                    <div style="font-size:2rem; margin-bottom:8px;">&#127961;</div>
                                    <div style="font-size:1.6rem; font-weight:800; color:var(--mcc-accent);">Un centre de dades, una petita ciutat</div>
                                    <p style="font-size:0.95rem; color:var(--mcc-text); margin:8px 0 0 0; line-height:1.5;">
                                        Un sol gran centre de dades pot consumir fins a <strong>19 milions de litres d'aigua al dia</strong> &mdash; tant com una ciutat de fins a 50.000 persones
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="mcc-reveal" style="animation-delay:0.45s;">
                    <div class="mcc-flip-card" id="mcc-card-2" onclick="mccFlipCard(2)">
                        <div class="mcc-flip-card-front">
                            <div style="font-size:2.5rem; margin-bottom:12px;">&#128274;</div>
                            <div style="font-size:1.1rem; font-weight:700; color:var(--mcc-text);">Escala</div>
                            <div style="font-size:0.9rem; color:var(--mcc-text-dim); margin-top:8px;">Toca per revelar</div>
                        </div>
                        <div class="mcc-flip-card-back" id="mcc-card-back-2">
                            <div style="text-align:center;">
                                <div class="mcc-knockout-stat">
                                    <div style="font-size:2rem; margin-bottom:8px;">&#127981;</div>
                                    <div style="font-size:1.6rem; font-weight:800; color:var(--mcc-accent);">100.000 xips, 100.000 llars</div>
                                    <p style="font-size:0.95rem; color:var(--mcc-text); margin:8px 0 0 0; line-height:1.5;">
                                        El centre de dades "Colossus" d'Elon Musk utilitza prop de 100.000 xips especialitzats i consumeix prou energia per abastir <strong>m&eacute;s de 100.000 llars</strong>.
                                    </p>
                                </div>
                                <p style="font-size:1rem; color:var(--mcc-text-dim); margin:16px 0 0 0; line-height:1.6;">
                                    I aix&ograve; &eacute;s nom&eacute;s <em>una</em> empresa. Google, Microsoft, Meta i Amazon estan competint per construir els seus propis.
                                </p>
                                <p style="font-size:0.8rem; color:var(--mcc-text-dim); margin:12px 0 0 0; font-style:italic;">
                                    Fonts: IEA, EESI, VU Amsterdam, informes TVA/xAI (2024&ndash;2025)
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div id="mcc-audit-summary" style="display:none; margin-top:20px;">
                    <div style="background:var(--mcc-accent-highlight); border:2px solid var(--mcc-accent); border-radius:16px; padding:20px 24px; text-align:center;">
                        <p style="margin:0; font-size:1.1rem; font-weight:600; color:var(--mcc-text); line-height:1.6;">
                            Energia. Aigua. Emissions. Cada model d'IA t&eacute; un cost m&eacute;s enll&agrave; de la seva puntuaci&oacute; de precisi&oacute; &mdash; <strong>i est&agrave; creixent r&agrave;pidament.</strong>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div id="mcc-reset-phase1" style="text-align:center;">
                    <div class="mcc-reveal" style="animation-delay:0s;">
                        <h2 id="mcc-recalc-header" class="mcc-blink-red" style="font-size:clamp(1.4rem, 4vw, 1.8rem); font-weight:800; margin:0 0 30px 0; letter-spacing:2px; text-transform:uppercase;">
                            RECALCULANT LA TEVA PUNTUACI&Oacute;...
                        </h2>
                    </div>
                        ...
                        <div class="mcc-gauge-container">
                            <div class="mcc-gauge" id="mcc-main-gauge">
                                <div class="mcc-gauge-inner">
                                    ...
                                    <div style="font-size:0.8rem; text-transform:uppercase; letter-spacing:2px; color:var(--mcc-text-dim);">PUNTUACI&Oacute;</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="mcc-reset-message" style="opacity:0; transition:opacity 1s; max-width:560px; margin:0 auto;">
                        <p style="font-size:1.1rem; color:var(--mcc-text); line-height:1.6;">
                            La teva precisi&oacute; es mant&eacute; en <strong id="mcc-accuracy-text">75.0%</strong>.
                        </p>
                        <p style="font-size:1rem; color:var(--mcc-text-dim); line-height:1.6;">
                            Per&ograve; ara introdu&iuml;m una nova manera de guanyar: la <strong style="color:var(--mcc-accent);">Puntuaci&oacute; de Br&uacute;ixola Moral</strong>.
                        </p>
                    </div>
                </div>
                ...
                <div id="mcc-formula-phase" style="display:none; margin-top:30px;">
                    <div style="background:var(--mcc-input-bg); padding:30px; border-radius:16px; text-align:center; border:2px dashed var(--mcc-accent); margin-bottom:24px;">
                        <p style="font-size:1.05rem; color:var(--mcc-text); line-height:1.6; margin:0 0 16px 0;">
                            Aquesta nova puntuaci&oacute; combina Precisi&oacute; i Sostenibilitat:
                        </p>
                        <div style="font-size:1.5rem; font-weight:700; margin:15px 0; color:var(--mcc-text); font-family:'Outfit',sans-serif;">
                            Puntuaci&oacute; de Br&uacute;ixola Moral =
                            <span style="background:rgba(5,150,105,0.15); color:var(--mcc-success); padding:4px 10px; border-radius:6px;">[ Precisi&oacute; ]</span>
                            &times;
                            <span style="background:rgba(217,119,6,0.15); color:var(--mcc-accent); padding:4px 10px; border-radius:6px;">[ Progr&eacute;s &Egrave;tic % ]</span>
                        </div>
                        <p style="font-size:0.95rem; margin:16px 0 0 0; color:var(--mcc-text-dim); line-height:1.6;">
                            Com que no has tingut en compte la Sostenibilitat en el teu model, el teu progr&eacute;s &egrave;tic &eacute;s <strong>0%</strong>.<br>
                            I si el progr&eacute;s &egrave;tic &eacute;s 0%, la puntuaci&oacute; final tamb&eacute; &eacute;s <strong>0</strong>.
                        </p>
                    </div>

                    <p style="font-size:1.05rem; color:var(--mcc-text); line-height:1.6; text-align:center; margin:0;">
                        En la pr&ograve;xima activitat aprendr&agrave;s sobre sostenibilitat i podr&agrave;s guanyar punts per recuperar la teva puntuaci&oacute;.
                    </p>
                </div>
            </div>
        """,
                ...
                <div class="mcc-reveal" style="animation-delay:0s;">
                    <div style="text-align:center; margin-bottom:8px;">
                        ...
                        <p style="font-size:1.05rem; color:var(--mcc-text-dim); margin:0 0 24px 0;">
                            Completa aquestes dues missions per guanyar punts sostenibilitat i restaurar la teva puntuaci&oacute; de la Br&uacute;ixola Moral.
                        </p>
                    </div>
                </div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; margin-bottom:24px;">
                    ...
                    <div class="mcc-reveal" style="animation-delay:0.15s;">
                        <div class="mcc-mission-card" style="border-left:4px solid #0284c7;">
                            ...
                            <h3 style="font-size:1.2rem; font-weight:800; color:#0284c7; margin:0 0 8px 0;">Detectiu d'IA verda</h3>
                            <p style="font-size:0.95rem; color:var(--mcc-text-dim); margin:0 0 12px 0; line-height:1.5;">
                                Investiga el veritable cost ambiental de la IA &mdash; des d'una sola consulta fins al planeta sencer.
                            </p>
                            <div style="font-size:0.85rem; color:var(--mcc-text-dim);">
                                <strong>4 investigacions</strong> &middot; <strong>4 q&uuml;estionaris</strong><br>
                                Guanya fins a un <strong style="color:#0284c7;">40% de Sostenibilitat</strong>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mcc-reveal" style="animation-delay:0.3s;">
                        <div class="mcc-mission-card" style="border-left:4px solid var(--mcc-success);">
                            ...
                            <h3 style="font-size:1.2rem; font-weight:800; color:var(--mcc-success); margin:0 0 8px 0;">Assessor/a d'IA verda</h3>
                            <p style="font-size:0.95rem; color:var(--mcc-text-dim); margin:0 0 12px 0; line-height:1.5;">
                                L'alcalde t'ha escollit per protegir la teva ciutat d'una empresa d'IA contaminant. Pren 5 decisions cr&iacute;tiques.
                            </p>
                            <div style="font-size:0.85rem; color:var(--mcc-text-dim);">
                                <strong>5 rondes</strong> &middot; <strong>6 q&uuml;estionaris</strong><br>
                                Guanya fins a un <strong style="color:var(--mcc-success);">60% de Sostenibilitat</strong>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mcc-reveal" style="animation-delay:0.45s;">
                    <div style="background:var(--mcc-input-bg); border-radius:12px; padding:16px 20px; text-align:center; margin-bottom:20px; border:1px solid var(--mcc-border-color);">
                        <span style="font-size:1rem; color:var(--mcc-text);">
                            Puntuaci&oacute; de Br&uacute;ixola Moral: <strong style="color:var(--mcc-error);">0.000</strong>
                            &nbsp;&middot;&nbsp;
                            Sostenibilitat: <strong style="color:var(--mcc-accent);">0%</strong>
                            &nbsp;&middot;&nbsp;
                            Precisi&oacute;: <strong id="mcc-summary-accuracy" style="color:var(--mcc-success);">75.0%</strong>
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="summary-box">
        <div class="summary-box-inner">
            <div class="summary-metrics">
                <div style="text-align:center;">
                    <div class="label-text">Puntuaci&oacute; de Br&uacute;ixola Moral</div>
                    <div class="score-text-primary">\U0001f9ed {display_score:.3f}</div>
                </div>
                <div class="divider-vertical"></div>
                <div style="text-align:center;">
                    <div class="label-text">Classificaci&oacute; per Equip</div>
                    <div class="score-text-team">{team_rank_display}</div>
                </div>
                <div class="divider-vertical"></div>
                <div style="text-align:center;">
                    <div class="label-text">Classificaci&oacute; Global</div>
                    <div class="score-text-global">{rank_display}</div>
                </div>
            </div>
            <div class="summary-progress">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:4px;">
                    <div class="progress-label">Progr&eacute;s del Curs: {progress_pct}%</div>
                </div>
...
def render_leaderboard_card(data, username, team_name):
    ...
    <div class="scenario-box leaderboard-card">
        <h3 class="slide-title" style="margin-bottom:10px;">\U0001f4ca Classificaci&oacute; en directe</h3>
        <div class="lb-tabs">
            ...
            <div class="lb-tab-panels">
                <div class="lb-panel panel-team">
                    <div class='table-container'>
                        <table class='leaderboard-table'>
                            <thead>
                                <tr><th>Posici&oacute;</th><th>Equip</th><th style='text-align:right;'>Mitjana \U0001f9ed</th></tr>
                            </thead>
                ...
                <div class="lb-panel panel-user">
                    <div class='table-container'>
                        <table class='leaderboard-table'>
                            <thead>
                                <tr><th>Posici&oacute;</th><th>Enginyer/a</th><th style='text-align:right;'>Puntuaci&oacute; \U0001f9ed</th></tr>
                            </thead>
...
(function mccInitTypewriter(){
    ...
    el.dataset.init = '1';
    var full = "El teu model d'IA est\u00e0 llest per al m\u00f3n real";
    var i = 0;
...
function mccFlipCard(idx) {
    ...
    if (progressEl) progressEl.textContent = count + '/3 revelats';
...
function mccRunGaugeDrain() {
    ...
    var interval = setInterval(function() {
        ...
        if (score <= 0) {
            ...
            if (header) header.textContent = 'PUNTUACI\u00d3 REINICIADA A ZERO';
            // Show message
            setTimeout(function(){
                if (msg) msg.style.opacity = '1';
...
function mccUpdateFormula(val) {
    ...
    if (sus === 0) {
        ...
        msgEl.textContent = "Aqu\u00ed \u00e9s on ets ara.";
    } else if (sus < 40) {
        resultEl.style.color = 'var(--mcc-error)';
        susEl.style.color = 'var(--mcc-accent)';
        msgEl.textContent = 'Comen\u00e7ant \u2014 cada punt compta.';
    } else if (sus < 70) {
        resultEl.style.color = 'var(--mcc-accent)';
        susEl.style.color = 'var(--mcc-accent)';
        msgEl.textContent = 'A mig cam\u00ed \u2014 ja marcant la difer\u00e8ncia.';
    } else {
        resultEl.style.color = 'var(--mcc-success)';
        susEl.style.color = 'var(--mcc-success)';
        if (sus === 100) {
            msgEl.textContent = 'Nota m\u00e0xima. Aix\u00ed \u00e9s un/a Enginyer/a d\\u2019IA responsable.';
        } else {
            msgEl.textContent = 'Fort comprom\u00eds amb la sostenibilitat!';
        }
    }
}
    ...
    with gr.Blocks(
        ...
        gr.HTML("""
            <div id="mcc-transition-overlay">
                ...
                <h2 style="color:#10b981; font-size:2rem; margin-bottom:10px; font-family:'Outfit',sans-serif;">Activitat completada</h2>
                <p style="color:#f8fafc; font-size:1.2rem; max-width:600px; font-family:'Outfit',sans-serif; line-height:1.6;">
                    A continuaci&oacute;: investiga la petjada ambiental de la IA com a <strong>Detectiu d'IA verda</strong>.
                </p>
                <button onclick="document.getElementById('mcc-transition-overlay').style.display='none'; try { window.parent.postMessage('navigate-to-activity-6', '*'); } catch(e) {}"
                    ...
                    CONTINUAR A L'ACTIVITAT 6 &rarr;
                </button>
            </div>
        """)
        ...
        with gr.Column(visible=True, elem_id="app-loader") as loader_col:
            gr.HTML(
                ...
                "<h2>Autenticant...</h2>"
                "<p>Sincronitzant dades de la Br&uacute;ixola Moral...</p>"
                "</div>"
            )
                ...
                <details style="background:var(--background-fill-secondary); border-radius:16px;
                    ...
                    <div style="padding:0 24px 24px 24px; text-align:center;">
                        ...
                        <p style="font-size:0.95rem; margin:12px 0 0 0; color:var(--body-text-color-subdued);">
                            <strong>Sostenibilitat %</strong> reflecteix el teu progr&eacute;s en la Br&uacute;ixola Moral a trav&eacute;s de les missions.<br/>
                            Si la teva Sostenibilitat % &eacute;s <strong>0%</strong>, la teva Puntuaci&oacute; de Br&uacute;ixola Moral &eacute;s <strong>0</strong>.
                        </p>
                    </div>
                </details>
            """)
        ...
        def handle_load(request: gr.Request):
            ...
            if ok:
                ...
                if best_acc == 0.0:
                    ...
                    <div style="background:rgba(217,119,6,0.15); border:2px solid var(--mcc-accent); padding:12px; border-radius:8px; margin-bottom:12px; text-align:center;">
                        <strong style="color:var(--mcc-accent);">Mode Demo:</strong>
                        <span style="color:var(--mcc-text-dim);">No s'ha pogut carregar la puntuaci&oacute; real del teu model. Es mostren valors d'exemple.</span>
                    </div>"""
            ...
            return (
                None, None, None,
                0.0, [],
                "<div class='hint-box'>Autenticaci&oacute; fallida. Si us plau, accedeix des de l'enlla&ccedil; del curs.</div>",
                "",
                """<div id="mcc-user-data" style="display:none"></div>
                <div style="background:rgba(217,119,6,0.15); border:2px solid var(--mcc-accent); padding:12px; border-radius:8px; margin-bottom:12px; text-align:center;">
                    <strong style="color:var(--mcc-accent);">Mode Demo:</strong>
                    <span style="color:var(--mcc-text-dim);">No s'ha pogut autenticar. Es mostren valors d'exemple.</span>
                </div>""",
                gr.update(visible=False),
                gr.update(visible=True),
            )
...
def launch_moral_compass_challenge_sustainability_ca_app(
    share: bool = False,
    ...
    **kwargs
    ...
    app = create_moral_compass_challenge_sustainability_ca_app(theme_primary_hue=theme_primary_hue)
    app.launch(
        share=share,
...
if __name__ == "__main__":
    launch_moral_compass_challenge_sustainability_ca_app(share=False, debug=True, height=1000)
