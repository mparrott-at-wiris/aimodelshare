        ...
        <div class="card">
            ...
            <div class="mission-step" id="step-3">
                ...
                <div class="btn-group" id="btnContinueReset"
                    ...
                    <button class="btn" onclick="goToStep(4)">INTRODUIR NOVA M\u00c8TRICA</button>
                </div>
            </div>
            ...
            <div class="mission-step" id="step-4">
                ...
                <div class="btn-group">
                    <button class="btn" style="width: 100%;" onclick="showTransition()">INICIAR AUDITORIA DE
...
def create_moral_compass_challenge_sustainability_ca_app(theme_primary_hue: str = "indigo"):
    with gr.Blocks(title="Activitat 5: El Cost de la Sostenibilitat") as demo:
