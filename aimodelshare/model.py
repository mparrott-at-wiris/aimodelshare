...
def submit_model(
    ...
    return_metrics: string, list, or boolean (default=None)
                    value - If provided, the function returns a 3rd element: a dictionary of evaluation metrics.
                    - If string (e.g. "accuracy"), returns dict with that specific metric.
                    - If list (e.g. ["accuracy", "f1_score"]), returns dict with those metrics.
                    - If True, returns dict with all available metrics.
    -----------------
    Returns
    response:   (model_version, model_page_url) - Default behavior
                (model_version, model_page_url, metrics_dict) - If return_metrics is set
    ...
    # --------------------------------------------------------------------------
    # NEW LOGIC: Handle optional return of metrics 
    # --------------------------------------------------------------------------
    if return_metrics:
